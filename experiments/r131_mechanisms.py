"""R-131 mechanisms — the two frozen branches, implemented verbatim.
...
`_selftest`), so the census in `r131_stepA_turnover_census.py` and the live
...
class NovelTurnoverThrottle(_ThrottledV4):
    ...
    name = "r131_novel_turnover_throttle"
