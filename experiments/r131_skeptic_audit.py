"""R-131 skeptic audit — the checks neither branch's own battery would run.
...
Writes `experiments/reports/r131_skeptic_audit_report.md`.
"""
...
from r131_mechanisms import ConservativeTurnoverBand, NovelTurnoverThrottle
from r131_shared import ETA, V4_NATURAL_TRADES_PER_DAY

OUT = Path(__file__).resolve().parent / "reports" / "r131_skeptic_audit_report.md"
