"""Shared, read-only utilities and pre-registration for the R-131 round (08-25).
...
- CONSERVATIVE (`r131_conservative_turnover_band.py`): track a causal
...
- NOVEL (`r131_novel_turnover_throttle.py`): maintain a causal shadow price
