"""R-131 NOVEL branch — online dual-ascent shadow price on turnover.
...
Writes `experiments/reports/r131_novel_report.md`.
"""
...
from r131_mechanisms import NovelTurnoverThrottle
...
OUT = Path(__file__).resolve().parent / "reports" / "r131_novel_report.md"
...
def main() -> None:
    ...
    w("# R-131 novel — online dual-ascent turnover throttle on `kelly_regime_v4`")
    w()
