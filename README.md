...
| **[docs/LEDGER.md](docs/LEDGER.md)** | **The memory.** Everything already tried — 27 registered strategies, and a research log of 188 rounds, newest first — the four binding constraints, the ruled-out list, and the ranked backlog. Read before a session, appended after it. |
...
188 rounds, the ruled-out list and the ranked backlog — is in
