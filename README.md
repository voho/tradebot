...
| **[docs/LEDGER.md](docs/LEDGER.md)** | **The memory.** Everything already tried — 26 registered strategies, and a research log of 156 rounds, newest first — the four binding constraints, the ruled-out list, and the ranked backlog. Read before a session, appended after it. |
...
The one-line summary of all twenty-six results: **every strategy that
...
Everything already tried — 26 registered strategies, a research log of
156 rounds, the ruled-out list and the ranked backlog — is in
