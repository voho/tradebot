...
| **[docs/LEDGER.md](docs/LEDGER.md)** | **The memory.** Everything already tried — 25 registered strategies, 35 research directions — the four binding constraints, the ruled-out list, and the ranked backlog. Read before a session, appended after it. |
...
> bar against this project's 199 trials — and neither does buy-and-hold.
...
Everything already tried — 25 registered strategies, 35 research
