...
| **[docs/LEDGER.md](docs/LEDGER.md)** | **The memory.** Everything already tried — 25 registered strategies, 32 research directions — the four binding constraints, the ruled-out list, and the ranked backlog. Read before a session, appended after it. |
...
Everything already tried — 25 registered strategies, 32 research
